...
def edit_telegram_message_with_buttons(
    message_id: str,
    new_text: str,
    button_mode: str = "override"
):
    ...
    if button_mode == "pending":
        ...
        keyboard = [
            [
                {
                    "text": "🚨 Override Alarm",
                    "callback_data": "override_alarm"
                },
                {
                    "text": "🔒 Override Lockdown",
                    "callback_data": "override_lockdown"
                }
            ],
            [
                {
